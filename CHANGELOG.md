...
### added
- `README.md` : demo video link after features list
- `slip39.c` : slip39 seed phrase compression and decompression converting word list in hex number index ([#58](https://github.com/ficaud/relic-core/issues/58))

### changed
- `base32` : move the base32 encoding/decoding in a subfolder in the `compression` to ease the code navigation
