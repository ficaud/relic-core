...
- **QR code support** — Generate scannable QR codes for each share on the split page, and reconstruct the secret on the unsplit page by taking a photo of each share (or picking an image from your Photo Library).
